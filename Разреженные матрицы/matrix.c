/*Мифи_информатика_курс онлайн 
Разреженные матрицы.
Вариант 1-4-2.
Схема размещения 1: цепочка ненулевых элементов в векторе А со строчным индексированием (индексы в массиве М равны -1, 
если соответствующая строка матрицы содерижт только нули).
...
//09.08.2020- Оно еще пидорит, надо пофиксить.
#include <complex.h>
#include <stdlib.h>
#include <stdio.h>
#include <stdbool.h>
